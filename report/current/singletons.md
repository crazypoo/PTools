...
| PooToolsSource/LocalConsole/LocalConsole.swift:393 | shared | D Shared mutable UI or scene state | public static let shared = LocalConsole() | 按 Scene 或控制器实例保存；保留兼容入口 |
