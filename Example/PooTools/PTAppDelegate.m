...
//    http://p3.music.126.net/VDn1p3j4g2z4p16Gux969w==/2544269907756816.jpg
    [PLaunchAdMonitor showAdAtPath:@[@"http://clips.vorwaerts-gmbh.de/big_buck_bunny.mp4"] onView:self.window.rootViewController.view timeInterval:3 detailParameters:@{} years:@"2000" skipButtonFont:APPFONT(16) comName:@"11111" comNameFont:APPFONT(12) callback:^{
    }];
