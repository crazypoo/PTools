...
-(void)adNotifi:(NSNotification *)obj
{
    PNSLog(@"123123444444555");
}
...
- (void)viewDidLoad
{
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(adNotifi:) name:@"PShowLaunchAdDetailNotification" object:nil];
