...
Pod::Spec.new do |s|
    ...
    s.dependency 'SDWebImage','YCXMenu','CYLTabBarController','Mantle','TOWebViewController','DZNEmptyDataSet','IQKeyboardManager','UITableView+FDTemplateLayoutCell','FDFullscreenPopGesture','LTNavigationBar','HTAutocompleteTextField','UIViewController+Swizzled','AFNetworking','FMDB','FLEX','JPFPSStatus','DHSmartScreenshot'
