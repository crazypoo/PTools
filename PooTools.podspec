...
#    s.static_framework = true
    ...
    s.subspec 'DEBUG' do |subspec|
        ...
        subspec.source_files = 'PooToolsSource/Debug/*.{h,m,swift}','PooToolsSource/LocalConsole/*.{h,m,swift}','PooToolsSource/DevMask/*.{h,m,swift}','PooToolsSource/TouchInspector/*.{h,m,swift}','PooToolsSource/DEBUGLocation/*.{h,m,swift}','PooToolsSource/Inspector/*.{h,m,swift}','PooToolsSource/DebugLibs/*.{h,m,swift}','PooToolsSource/DebugCrash/*.{h,m,swift}','PooToolsSource/DebugFile/*.{h,m,swift}'
    subspec.pod_target_xcconfig = {
