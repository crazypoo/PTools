...
#        subspec.dependency 'PooTools/MicPermission'
    ...
    s.subspec 'GoogleMap' do |subspec|
        subspec.dependency 'PooTools/Core'
        subspec.dependency 'GoogleMaps'
        subspec.dependency 'Google-Maps-iOS-Utils'
        subspec.pod_target_xcconfig = {
            "SWIFT_ACTIVE_COMPILATION_CONDITIONS"  => "POOTOOLS_GOOGLEMAP POOTOOLS_COCOAPODS"
        }
    end
