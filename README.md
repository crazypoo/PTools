...
```ruby
pod 'PooTools/Core', :git => 'https://github.com/crazypoo/PTools.git', :tag => '4.5.17'
pod 'PooTools/NetWork', :git => 'https://github.com/crazypoo/PTools.git', :tag => '4.5.17'
pod 'PooTools/PhotoPicker', :git => 'https://github.com/crazypoo/PTools.git', :tag => '4.5.17'
```
