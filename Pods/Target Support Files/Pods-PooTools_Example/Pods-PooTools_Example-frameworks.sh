...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/InAppViewDebugger/InAppViewDebugger.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/PermissionsKit/PermissionsKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/PhoneNumberKit/PhoneNumberKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/PooTools/PooTools.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SDWebImage/SDWebImage.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SJAttributesStringMaker/SJAttributesStringMaker.framework"
