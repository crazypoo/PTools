//
//  UIView+PTListAnimationEX.swift
//  PooTools_Example
//
...
public extension UIView {
    ...
    func animate(animations:[PTListAnimationProtocols],
                 reversed:Bool = false,
    ...
    /**
     ...
     - Parameters:
       - animations: An array of `PTListAnimationProtocols` objects representing the transformations to be applied in each keyframe.
       ...
       - duration: The total duration of the animation. Default is the value specified in `PTListAnimationConfig.duration`.
     ...
     The `animateKeyFrames` method animates a series of keyframes, each defined by an `PTListAnimationProtocols` object.
    ...
    static func animate(views:[UIView],
                        animations:[PTListAnimationProtocols],
                        reversed:Bool = false,
                        initialAlpha:CGFloat = 0.0,
                        finalAlpha:CGFloat = 1.0,
                        delay:Double = 0,
        ...
        performAnimation(views: views, 
                         animations: animations,
                         reversed: reversed,
                         initialAlpha: initialAlpha,
                         delay: delay,
                         animationBlock: { view, index, dispatchGroup in
    ...
    static private func performAnimation(views:[UIView],
        ...
        PTGCDManager.gcdAfter(time: delay) {
