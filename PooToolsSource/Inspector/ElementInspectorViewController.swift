...
final class ElementInspectorViewController: ElementInspectorPanelViewController, KeyboardAnimatable, DataReloadingProtocol {
    ...
    override var preferredContentSize: CGSize {
        didSet {
            PTNSLogConsole(classForCoder, #function, preferredContentSize)
        }
    }
...
extension ElementInspectorViewController: @MainActor ElementInspectorFormPanelItemStateDelegate {
