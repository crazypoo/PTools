//
//  PTRouterDynamicParamsMapping.m
//  PooTools_Example
//
...
@implementation PTRouterDynamicParamsMapping

+ (instancetype)router {
    static PTRouterDynamicParamsMapping *router;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        router = [[PTRouterDynamicParamsMapping alloc] init];
...
@implementation NSObject (PTRouterClass)
...
- (ReturnStruct)setPropertyParameter:(NSDictionary*)propertyParameter{
    ...
    // 移除指定的键
    [filteredDictionary removeObjectsForKeys:[PTRouterDynamicParamsMapping router].filterKey];
