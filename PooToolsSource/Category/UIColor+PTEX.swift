...
public extension UIColor {
     ...
     */
    func mixWithColor(_ color: UIColor,
    @PTClampedProperyWrapper(range:0...1) amount: CGFloat = 0.25) -> UIColor {
        var r1     : CGFloat = 0
        var g1     : CGFloat = 0
        var b1     : CGFloat = 0
     ...
     */
    @available(iOS 13.0, *)
    static var systemDownedBackground: UIColor {
...
#if os(iOS)
    /**
        New color to system grouped stack.
    ...
    static var systemDownedGroupedBackground: UIColor {
        return UIColor.init(dynamicProvider: { trait in
            if trait.userInterfaceStyle == .light {
                ...
                return UIColor.secondarySystemGroupedBackground.withAlphaComponent(0.7)
            }
        })
    }
#endif
