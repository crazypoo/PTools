...
- (instancetype)initWithRateBlock:(PStarRateViewRateBlock)block{
    return [self initWithNumberOfStars:DEFALUT_STAR_NUMBER imageForeground:[[UIColor redColor] createImageWithColor] imageBackGround:[[UIColor blueColor] createImageWithColor] withTap:YES rateBlock:block];
}
