...
public extension DynamicColor {
     ...
     */
    final func mixed(withColor color: DynamicColor, @PTClampedProperyWrapper(range:0...1) weight: CGFloat = 0.5, inColorSpace colorspace: DynamicColorSpace = .rgb) -> DynamicColor {
     ...
     */
    final func tinted(@PTClampedProperyWrapper(range:0...1) amount: CGFloat = 0.2) -> DynamicColor {
     ...
     */
    final func shaded(@PTClampedProperyWrapper(range:0...1) amount: CGFloat = 0.2) -> DynamicColor {
