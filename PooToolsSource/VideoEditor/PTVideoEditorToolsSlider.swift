...
class PTVideoEditorToolsSlider: UIControl {
    ...
    enum Constants {
        ...
        @MainActor static let backgroundColor: CGColor = UIColor.background.cgColor
        ...
        @MainActor static let trackerInnerCircleBackgroundColor = UIColor.foreground.cgColor
