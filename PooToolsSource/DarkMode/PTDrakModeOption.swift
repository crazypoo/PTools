...
public class PTDarkModeOption {
    ...
    ///选中
    @MainActor public static var tradeValidperiodSelected = Bundle.podBundleImage(bundleName: CorePodBundleName, imageName: "icon_cycle_selected@3x")
    /// 没有选中
    @MainActor public static var tradeValidperiod = Bundle.podBundleImage(bundleName: CorePodBundleName, imageName: "icon_cycle_unselected@3x")

    @MainActor public static var smartCellName = "PT Theme smart".localized()
    @MainActor public static var followSystemCellName = "PT Theme follow system".localized()
    @MainActor public static var timeSetErrorMsg = "PT Theme time set error".localized()
    @MainActor public static var titleSting = "PT Theme title".localized()
    @MainActor public static var cellFont:UIFont = .appfont(size: 16)
    @MainActor public static var footerDesc:String = "PT Theme system info".localized()
    @MainActor public static var mtTitle:String = "PT Theme mt".localized()
    @MainActor public static var mtTitleFont:UIFont = .appfont(size: 16)
    @MainActor public static var whiteThemeString:String = "PT Theme white".localized()
    @MainActor public static var blackThemeString:String = "PT Theme black".localized()
    @MainActor public static var themeSelectFont:UIFont = .appfont(size: 13)
    @MainActor public static var pickerCancel:String = "PT Button cancel".localized()
    @MainActor public static var pickerDone:String = "PT Button comfirm".localized()
    public static var pickerFont:UIFont = .appfont(size: 16)
    public static var pickerLabelFont:UIFont = .appfont(size: 18)
    @MainActor public static var themeSmartInfo:String = "PT Theme smart info".localized()
    @MainActor public static var themeSubNightTitle:String = "PT Theme night".localized()
    @MainActor public static var themeSubTimeTitle:String = "PT Theme time".localized()
