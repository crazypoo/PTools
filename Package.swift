...
let package = Package(
    ...
    products: [
        ...
        .library(name: "Thermometer", targets: ["Thermometer"]),
    ...
    targets: [
        ...
        .target(name: "Thermometer",dependencies: [.target(name: "PTools")],swiftSettings: [.define("PTOOLS_THERMOMETER"),.define("PTOOLS_SPM")]),
