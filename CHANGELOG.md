...
当前开发基线为 `5.19.2`，尚未创建正式 Git tag；版本唯一来源为根目录 `VERSION`。
...
5.11.11  5.11.12  5.11.13  5.11.14  5.11.16  5.11.17  5.12.1  5.13.0  5.14.0  5.15.0  5.16.0  5.17.0  5.18.0  5.18.2  5.19.1
```

`5.9.1`、`5.9.8`、所有 `5.10.x`、`5.11.0`、`5.11.1` 和 `5.11.15` 当前没有对应 Git tag，
因此不作为已发布版本列出；`5.19.2` 当前仍是开发基线。
